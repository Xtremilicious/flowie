...
import { GoIssueOpened, GoLinkExternal, GoIssueClosed, GoCommentDiscussion } from "react-icons/go";
      ...
      <PRContainer>
        <div className="accordion" id="accordionExample">
          <div className="pr-container">
            <div className={value.state === "open" ? "icon status-open" : "icon status-close"}>
              {value.state === "open" ? <GoIssueOpened /> : <GoIssueClosed />}
            </div>
            <div className="pr-info">
              <div className={value.state === "open" ? "title status-open" : "title status-close"}>
